...
UsersModule = __decorate([
    (0, common_1.Module)({
        ...
        imports: [
            (0, common_1.forwardRef)(() => tokens_module_1.TokensModule),
            activates_module_1.ActivatesModule,
            sequelize_1.SequelizeModule.forFeature([user_model_1.User, token_model_1.Token, activate_model_1.Activate]),
        ],
        exports: [
